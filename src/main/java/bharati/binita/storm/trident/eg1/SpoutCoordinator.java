...
public class SpoutCoordinator implements BatchCoordinator<Object>, Serializable{//Object is the metadata type

	private static Logger logger = LoggerFactory.getLogger(SpoutCoordinator.class);
