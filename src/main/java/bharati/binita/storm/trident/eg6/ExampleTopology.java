 ...
 *  - Demo of Transactional State. (Refer to Transactional spout here : https://storm.incubator.apache.org/documentation/Trident-state)
 *  - Batch replay on throwing FailedException from component used in persistentAggregate API.
 *  - State API usage, using storm.trident.state.map.MapState API. This example shows use of TransactionalMap MapState type.
...
public class ExampleTopology {
	...
	public static void main(String[] args) throws Exception {
		...
		StormSubmitter.submitTopology("trident-eg6", conf,
        		buildTopology());
