...
public class RandomWordCoordinator implements BatchCoordinator<Object>, Serializable{//Object is the metadata type

	private static Logger logger = LoggerFactory.getLogger(RandomWordCoordinator.class);
