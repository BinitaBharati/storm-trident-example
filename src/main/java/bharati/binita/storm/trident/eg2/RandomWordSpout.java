...
public class RandomWordSpout implements ITridentSpout<Object>{
	private RandomWordCoordinator coordinator = new RandomWordCoordinator();
	private RandomWordEmitter emitter = new RandomWordEmitter();
