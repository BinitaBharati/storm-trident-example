...
public class RandomWordEmitter implements Emitter<Object>, Serializable{//Object is the type of the tuple that will be emitted
	
	private static Logger logger = LoggerFactory.getLogger(RandomWordEmitter.class);
